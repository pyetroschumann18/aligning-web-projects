...
```bash
git clone https://github.com/OWNER/REPOSITORY.git ~/.agents/skills/aligning-web-projects
```

No PowerShell do Windows, você pode usar:

```powershell
git clone https://github.com/OWNER/REPOSITORY.git "$env:USERPROFILE\.agents\skills\aligning-web-projects"
```
